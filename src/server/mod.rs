...
pub mod mechanisms {
    mod plain {
        ...
        use common::{Identity, ChannelBinding, Credentials, Secret};
    ...
    mod scram {
        ...
        use server::{Validator, Response, Mechanism};
        use common::{Identity, ChannelBinding, Credentials, Secret, parse_frame, xor};
        ...
        impl<S: ScramProvider, V: Validator> Mechanism<V> for Scram<S, V> {
            ...
            fn respond(&mut self, payload: &[u8]) -> Result<Response, String> {
                ...
                match self.state {
                    ...
                    ScramState::SentChallenge { server_nonce: ref server_nonce
